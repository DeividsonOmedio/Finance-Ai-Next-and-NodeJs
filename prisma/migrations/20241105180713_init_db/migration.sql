...
-- CreateEnum
CREATE TYPE "TransactionPayamentMethod" AS ENUM ('CREDIT_CARD', 'DEBIT_CARD', 'BANK_TRANSFER', 'BANH_SLIP', 'CASH', 'PIX', 'OTHER');
...
CREATE TABLE "Transaction" (
    ...
    "payamentMethod" "TransactionPayamentMethod" NOT NULL,
